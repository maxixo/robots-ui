...
import { HambugerMenu } from "../components/design/design/Header";
...
const Header = () => {
  ...
  return (
    <div
      className={`fiexd top-0 left-0 w-full z-50 border-b border-n-6 lg:bg-n-8/90 lg:backdrop-blur-sm ${
    ...
    >
      <div
        ...
        max-lg:py-4"
      >
        <a className="block w-[12rem] xl:mr-8 href='hero" href="#hero">
